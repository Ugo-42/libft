...
#    Updated: 2025/04/04 10:11:12 by ugwentzi         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = allocation/ft_calloc.c                  allocation/ft_calloc_2d.c \
       ...
       cleanup/ft_cexit.c                      color/ft_change_color.c \
       color/ft_darken_color.c                 color/ft_brighten_color.c \
       ...
       count/ft_strnlen.c                      count/ft_strlen_2d.c \
       ...
       flexible_string/flexistr_append.c       flexible_string/flexistr_n_append.c \
       flexible_string/flexistr_finalize.c     flexible_string/flexistr_free.c \
       flexible_string/flexistr_init.c         flexible_string/flexistr_resize.c \
       ...
       maths/ft_next_power_of_2.c              maths/ft_percentile_strnb.c \
       ...
       memory/ft_ultimate_bzero.c              other/ft_segfault.c \
