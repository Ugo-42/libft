...
#    Updated: 2025/02/03 09:54:32 by ugwentzi         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = allocation/ft_calloc.c					allocation/ft_free_2d_array.c \
       allocation/ft_free_null.c				allocation/ft_realloc.c \
       conversion/ft_addrtoa.c					conversion/ft_atoi.c \
       conversion/ft_ctoa.c						conversion/ft_itoa.c \
       ...
       error/ft_exit_error.c					is/ft_isalnum.c \
       is/ft_isalpha.c							is/ft_isascii.c \
       is/ft_isdigit.c							is/ft_isprint.c \
       is/ft_isquote.c							is/ft_isspace.c \
       ...
       memory/ft_swap_content.c					other/ft_segfault.c \
       ...
       print/ft_putunbr_fd.c					print/stdout/ft_putstr.c \
       ...
       sorting/ft_qsort.c						string/ft_split.c \
       ...
       string/ft_strndup.c						string/ft_strdup_2d.c \
