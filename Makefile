...
#    Updated: 2025/02/21 13:52:20 by ugwentzi         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = allocation/ft_calloc.c					allocation/ft_free_2d_array.c \
       allocation/ft_free_2d_char_array.c		allocation/ft_free_null.c \
       allocation/ft_realloc.c					conversion/ft_addrtoa.c \
       ...
       count/ft_utf8_charlen.c					count/ft_utf8_strlen.c \
       count/ft_utf8_visual_len.c				count/ft_utf8_count_bytes.c \
       error/ft_exit_error.c					error/ft_cexit_error.c \
       error/ft_fexit_error.c					error/ft_fcexit_error.c \
       ...
       maths/ft_min_strnb.c						maths/ft_percentile_strnb.c \
       ...
       other/ft_color.c							other/ft_segfault.c \
       ...
       print/stdout/ft_putstr.c					print/stdout/ft_putstr_colored.c \
       print/stdout/ft_putstr_nl.c				print/stdout/ft_putstr_nl_colored.c \
       ...
       string/ft_strcpy.c						string/ft_strdup.c \
