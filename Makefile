...
#    Updated: 2025/03/20 09:44:05 by ugwentzi         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
allocation/ft_calloc_2d.c \
allocation/ft_free_2d_array.c \
allocation/ft_free_2d_char_array.c \
allocation/ft_free_null.c \
allocation/ft_malloc_2d.c \
allocation/ft_realloc.c \
color/ft_change_color.c \
color/ft_loop_color.c \
color/ft_loop_color_value.c \
color/ft_print_colored.c \
color/ft_print_nl_colored.c \
color/ft_print_rainbow.c \
color/ft_print_shade.c \
color/ft_reset_color.c \
