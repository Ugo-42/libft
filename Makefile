...
#    Updated: 2025/01/16 12:26:31 by ugwentzi         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = allocation/ft_calloc.c				allocation/ft_free_2d_array.c \
       ...
       count/ft_utf8_strlen.c				error/ft_exit_error.c \
       is/ft_isalnum.c						is/ft_isalpha.c \
       is/ft_isascii.c						is/ft_isdigit.c \
       is/ft_isprint.c						is/ft_isquote.c \
       is/ft_isspace.c						list/ft_lstadd_back.c \
       ...
       other/ft_segfault.c					print/ft_fprintf.c \
       ...
       print/ft_putstr_fd.c					print/ft_putstrn_fd.c \
       print/ft_putunbr_fd.c				read/get_next_line.c \
       ...
       string/ft_strncpy.c					string/ft_strnstr.c \
       string/ft_strrchr.c
